        ...
        <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-4">
            <div className="w-full max-w-3xl">
                ...
                <Card className="border-0 shadow-xl overflow-hidden">
                    ...
                    <CardFooter className="flex flex-col gap-4 bg-slate-50 p-8 border-t">
                        {error && (
                            <div className="w-full p-4 rounded-xl bg-red-50 border-2 border-red-300 text-sm font-bold text-red-900 flex items-center gap-2 animate-in fade-in slide-in-from-top-3 duration-200">
