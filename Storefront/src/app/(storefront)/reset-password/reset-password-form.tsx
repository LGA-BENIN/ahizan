        ...
        <Card className="shadow-xl">
            ...
            <form action={formAction}>
                ...
                <CardFooter className="flex flex-col space-y-4 pt-6">
                    ...
                    <Button type="submit" className="w-full bg-[#0d213d] hover:bg-[#0d213d]/90 text-white font-bold" disabled={isPending}>
                        {isPending ? 'Réinitialisation...' : 'Réinitialiser le mot de passe'}
                    </Button>
                    <Link
                        href="/sign-in"
                        className="text-sm text-center text-muted-foreground hover:text-primary font-semibold"
                    >
