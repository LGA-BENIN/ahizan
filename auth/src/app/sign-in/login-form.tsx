...
export function LoginForm({ redirectTo }: LoginFormProps) {
  ...
  return (
    <main className="flex-grow flex items-stretch min-h-screen">
      ...
      <section className="w-full lg:w-1/2 flex items-center justify-center p-gutter relative">
        <div className="bg-white rounded-[28px] shadow-[0px_10px_30px_rgba(0,0,0,0.04)] w-full max-w-[450px] p-10 z-10 flex flex-col">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              ...
              <div className="relative group">
                <input
                  className="w-full h-12 px-4 bg-surface-light border-0 focus:ring-2 focus:ring-primary rounded-xl transition-all font-body-md text-on-surface"
                  id="identifier"
                  name="identifier"
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer group">
                <input className="w-5 h-5 rounded border-outline-variant text-primary focus:ring-primary" type="checkbox" name="remember" />
            ...
            <button
              className="w-full h-12 bg-primary hover:bg-primary-container text-white font-bold rounded-xl shadow-lg hover:shadow-primary/20 transition-all active:scale-95 duration-100 flex items-center justify-center gap-2"
              type="submit"
              disabled={isPending}
            >
          ...
          <button className="w-full h-12 border border-outline-variant hover:bg-surface-light text-on-surface font-label-md text-label-md rounded-xl transition-all flex items-center justify-center gap-3 active:scale-[0.98]">
