    ...
    <div style={{ padding: 24, maxWidth: 1100, margin: '0 auto' }}>
      ...
      >
        ...
        <ul style={{ fontSize: 13, color: '#6b7280', paddingLeft: 20, lineHeight: 1.6 }}>
          ...
          <li>Feuille Collections: name, name_en, slug, parent_slug, description, description_en, featured_asset_url, position, allowed_facet_ids, facet_value_codes, variant_ids, inherit_filters, is_private</li>
