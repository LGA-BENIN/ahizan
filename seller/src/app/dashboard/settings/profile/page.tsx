    ...
    return (
        <div className="space-y-8">
            <div className="flex items-center gap-4">
                ...
                <h1 className="text-3xl font-serif font-bold">Profil du créateur</h1>
            </div>

            <VendorProfileForm
                initialName={vendor?.name || ''}
                title="Votre profil"
                description="Personnalisez la façon dont vous apparaissez aux clients sur la plateforme."
            />
        </div>
    );
}
