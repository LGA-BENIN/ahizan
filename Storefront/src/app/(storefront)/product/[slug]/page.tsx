                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className="grid md:grid-cols-3 gap-8 text-center">
                        <div className="space-y-3">
                            ...
                            <p className="text-muted-foreground">Des produits sélectionnés avec soin pour leur qualité</p>
                        </div>
                        <div className="space-y-3">
                            <div className="w-12 h-12 mx-auto bg-primary/10 rounded-full flex items-center justify-center">
                                <svg className="w-6 h-6 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <h3 className="text-xl font-semibold">Vendeurs locaux</h3>
                            <p className="text-muted-foreground">Soutenez le commerce local et les entrepreneurs de votre région</p>
                        </div>
                        <div className="space-y-3">
                            <div className="w-12 h-12 mx-auto bg-primary/10 rounded-full flex items-center justify-center">
                                <svg className="w-6 h-6 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <h3 className="text-xl font-semibold">Satisfaction garantie</h3>
                            <p className="text-muted-foreground">Paiement sécurisé et suivi de vos commandes</p>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="container mx-auto px-4 max-w-3xl">
                    ...
                    <Accordion type="single" collapsible className="w-full">
                        <AccordionItem value="shipping">
                            <AccordionTrigger>Quelles sont vos options de livraison ?</AccordionTrigger>
                            <AccordionContent>
                                La livraison est gérée par chaque vendeur. Les délais et tarifs varient selon la zone géographique. Consultez les informations de livraison du vendeur sur sa page.
                            </AccordionContent>
                        </AccordionItem>
                        <AccordionItem value="returns">
                            <AccordionTrigger>Quelle est la politique de retour ?</AccordionTrigger>
                            <AccordionContent>
                                Chaque vendeur définit sa propre politique de retour. Consultez les conditions sur la page du vendeur avant d'acheter.
                            </AccordionContent>
                        </AccordionItem>
                        <AccordionItem value="tracking">
                            <AccordionTrigger>Comment suivre ma commande ?</AccordionTrigger>
                            <AccordionContent>
                                Connectez-vous à votre compte et consultez la section "Mes commandes" pour suivre l'état de vos commandes en temps réel.
                            </AccordionContent>
                        </AccordionItem>
                        <AccordionItem value="international">
                            <AccordionTrigger>Comment contacter un vendeur ?</AccordionTrigger>
                            <AccordionContent>
                                Rendez-vous sur la page du vendeur pour trouver ses coordonnées de contact. Vous pouvez également lui envoyer un message via WhatsApp si cette option est disponible.
                            </AccordionContent>
                        </AccordionItem>
                    </Accordion>
                </div>
