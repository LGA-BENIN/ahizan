...
export default async function Home(_props: any) {
    // 1. On tente de récupérer le contenu depuis le CMS pour le slug 'home'
    const cmsPage = await getPageContent('home');

    // 2. Fallback statique si la page n'est pas configurée dans Vendure
